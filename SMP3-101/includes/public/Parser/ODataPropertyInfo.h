 ...
 * the stored type will be set to EDM_TYPE_COMPLEX in the ODataPropertyInfo instance.
 */
enum TEN_EDM_TYPES {
 ...
 */
@interface ODataPropertyInfo : NSObject <NSCoding> {
	//OData property info>>
	NSString*						m_Name;
 ...
 */
-(ODataPropertyInfo* const) getPropertyInfoByPath:(NSString* const)path;

#pragma mark -
#pragma mark Private API
//Adds child property info objects>>
-(void) addChildPropertyInfo:(const ODataPropertyInfo* const)child;
