...
@interface ODataEntitySchema : NSObject <NSCoding> {
	...
	//name should not be stored here, because this class is referenced from ODataCollection and that stores the name 
	int						m_ContentVersion;
	uint16_t				m_Flags;
	ODataPropertyInfo*	m_Root;
...
@property (nonatomic, retain, getter=getRoot, setter=setRoot:) ODataPropertyInfo* root;
