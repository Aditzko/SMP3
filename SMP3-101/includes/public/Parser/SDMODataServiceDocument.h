 ...
 */
__attribute((deprecated("Use ODataServiceDocument instead")))
@interface SDMODataServiceDocument : NSObject <NSCoding> {
	enum TEN_SERVER_TYPES	m_ServerType;
	NSString*				m_DocumentLanguage;
	NSString*				m_BaseUrl;
	SDMODataSchema*			m_Schema;
...
@property (nonatomic, retain, getter=getSchema, setter=setSchema:) SDMODataSchema* schema;
