 ...
 */
@interface ODataCollection : NSObject <NSCoding> {
...
@property (nonatomic, retain, getter=getEntitySchema, setter=setEntitySchema:) ODataEntitySchema* entitySchema;
@property (nonatomic, retain, getter=getOpenSearchDescription, setter=setOpenSearchDescription:) const OpenSearchDescription* openSearchDescription;
...
/**
 * if the collection supports subscription, then the returned object will be an ODataLink, otherwise nil.
 */
...
-(BOOL) addLink:(const ODataLink* const)newLink;
-(BOOL) addIcon:(const ODataIconInfo* const)newIcon;
@end
