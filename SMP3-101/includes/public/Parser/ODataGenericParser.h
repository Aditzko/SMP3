...
#import "ODataParserDelegate.h"


@interface ODataGenericParser : NSObject<NSXMLParserDelegate, ODataParserDelegate> {
	NSMutableString*	m_Path;
	int					m_Level;
	NSMutableString*	m_LastValue;
	BOOL				m_HasBufferedValue;
	NSXMLParser*		m_Parser;
	ODataParserException*		m_Exception;
...
@property (nonatomic, retain, getter=getException, setter=setException:) ODataParserException* exception;
